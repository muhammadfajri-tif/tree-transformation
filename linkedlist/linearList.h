...
typedef address infotypeP;
typedef struct tElmtList* addressP;
...
/* Setiap elemen dengan addressP P dapat diacu info(P) dan Next(P);  */
/* Elemen terakhir list ===> Jika addressPnya Last maka Next(Last) = Nil */
typedef struct
{
	addressP First;
} List;
